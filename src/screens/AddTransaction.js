  ...
  return (
    <SafeAreaView className={`flex-1 relative`}>
        <View className={`w-full h-[10%] flex flex-row`}>
            <TouchableOpacity className={`w-[15%] h-full flex items-center justify-center`} onPress={() => {
                navigation.goBack()
            }}>
    ...
    <TouchableOpacity className={`w-[55%] h-[100%] shadow border-[0.25px] border-[#614bc3] rounded-2xl flex items-center justify-center bg-[#614bc3] mb-28`}>
