import { View, Text, SafeAreaView, TouchableOpacity, TextInput, ScrollView, Dimensions, Image, Linking } from 'react-native'
import Ionicons from "@expo/vector-icons/Ionicons";
import { useNavigation } from '@react-navigation/native';

import testImage from "../../assets/images/test.jpeg";
import Lotus from "../../assets/images/getStarted.png";
...
const InternationalDealsComponent = (props) => {
  ...
  const storelink = () => {
   ...
   const { width, height } = Dimensions.get('window');
    ...
    return (
      <TouchableOpacity className={`w-[200px] h-[95%] flex items-center justify-center`} onPress={storelink}>
        <View className={`w-[90%] h-[65%] rounded-md shadow border-[0.25px] border-gray-300 bg-white flex items-center justify-center`}>
          <Image source={{ uri: props.image }} className="w-full h-full object-cover rounded-md"/>
        </View>
...
const internatialDealData = [
  {
    ...
    image: 'https://res.cloudinary.com/dgdbxflan/image/upload/v1703477324/IMG_3085_uz4xc2.jpg',
    redirectURL: 'https://www.apple.com/my-edu/store',
  },
  {
    store: "Samsung",
    category: "Electronic Devices",
    image: 'https://res.cloudinary.com/dgdbxflan/image/upload/v1703477324/IMG_3089_p5abf4.jpg',
    redirectURL: 'https://www.samsung.com/my/offer/student-discounts/',
  },
...
const localDealData = [

  {
    ...
    image: 'https://res.cloudinary.com/dgdbxflan/image/upload/v1703477324/IMG_3088_zmbvdi.png',
  },  {
    store: "ZUS Coffee",
    category: "Coffee Brewer",
    image: 'https://res.cloudinary.com/dgdbxflan/image/upload/v1703477324/IMG_3087_fufmus.jpg',
  },
]
